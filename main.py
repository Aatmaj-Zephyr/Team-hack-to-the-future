...
def initiate_Normal_layout(float_layout):
    ...
    background_image = Image(source ='Unknown wallpaper.jpeg',on_touch_down=press,allow_stretch=True, keep_ratio=False,opacity = 0.3,size_hint=(.8, .6),pos_hint={'center_x':0.5, 'center_y':0.5})
    person_float_layout.add_widget(background_image)
    person_label = Label(text="Unidentified Acess!!", font_size=50,color="blue", size_hint=(.2, .2), pos_hint={'center_x':0.5, 'center_y':0.5})
   ...
   # accept_Button= Button(text="accept",size_hint=(.1,.1),pos_hint={'center_x':0.8, 'center_y':0.30},background_color=(0,1,0,1))
    ...
    accept_label=Label(text="accept",bold=True,color="green",size_hint=(.1,.1),pos_hint={'center_x':0.8, 'center_y':0.25})
    ...
    decline_label = Label(text="decline",bold=True, color="red", size_hint=(.1, .1), pos_hint={'center_x': 0.2, 'center_y': 0.25})
    person_float_layout.add_widget(decline_label)

    decline_Button = Image(source='icons8-warning-64.png', on_touch_down=press,
                           pos_hint={'center_x': 0.5, 'center_y': 0.70})
    person_float_layout.add_widget(decline_Button)
    decline_label = Label(text="Warning!!", bold=True,color="red", size_hint=(.1, .1), pos_hint={'center_x': 0.5, 'center_y': 0.65})
    person_float_layout.add_widget(decline_label)
